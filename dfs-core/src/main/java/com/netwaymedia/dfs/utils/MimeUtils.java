...
public final class MimeUtils {
	 ...
	 * supplying your own "content.types.user.table" means you don't get any of the
	 * built-ins, and the built-ins come from
	...
	/**
	 * Returns the registered extension for the given MIME type. Note that some MIME
